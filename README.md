...
Extend Argent's core logic with Python plugins stored in `~/.argent/hooks/`.
...
Argent — это высокопроизводительный профессиональный ИИ-напарник, который живет в вашем терминале. Он использует локальные модели Ollama и продвинутые архитектурные паттерны для создания автономной, эффективной и безопасной среды разработки.
...
Расширяйте логику Argent с помощью Python-плагинов в папке `~/.argent/hooks/`.
